...
const Navbar = () => {
    ...
    const menuItems = <React.Fragment>
        ...
        <li><Link to='/allProductsCategories'>Gallery</Link></li>
        ...
        <div className="navbar bg-base-100 flex justify-between">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={1} className="font-bold menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                        {menuItems}
                    </ul>
                </div>
